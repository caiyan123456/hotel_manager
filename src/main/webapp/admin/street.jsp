...
<head>
    ...
    <script language="JavaScript">
        $(function(){
            ...
            $('#dg').datagrid({
                ...
                columns: [[
                    ...
                    { field: 'name', title: '街道', width: 50, align: "center" },
                    { field: 'districtId', title: '区域Id', width: 50, align: "center" },
        ...
        function DeleteMore(){
            ...
            //发送异步请求到服务器
            $.post("deleteMoreStreet",{"ids":delValue},function(data){
                if(data.result>0){
                    $("#dg").datagrid('reload');
