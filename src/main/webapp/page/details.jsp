...
<DIV class=intro>
<DIV class=lefter>
<H1>${housePlus.title}</H1>
<DIV class=subinfo>2013-06-28 14:06:33.0</DIV>
<DIV class=houseinfo>

<P>图　　片：</P>
  <img src="http://localhost:80/${housePlus.path}" width="600" height="400" alt="请上传图片"/>

<P>户　　型：<SPAN>${housePlus.tname}</SPAN></P>
<P>面　　积：<SPAN>${housePlus.floorage}m<SUP>2</SUP></SPAN></P>
<P>位　　置：<SPAN>${housePlus.sname}</SPAN></P>
<P>联系方式：<SPAN>${housePlus.contact}</SPAN></P></DIV></DIV>
<DIV class=side>
<P><A class=bold href="http://localhost:8080/House-2/#">武汉房地产经纪公司</A></P>
<P>资质证书：有</P>
<P>内部编号:1001</P>
<P>联 系 人：何静</P>
<P>联系电话：18771931377<SPAN></SPAN></P>
<P>手机号码：15002731811<SPAN></SPAN></P></DIV>
<DIV class=clear></DIV>
<DIV class=introduction>
<H2><SPAN><STRONG>房源详细信息</STRONG></SPAN></H2>
<DIV class=content>
<P>${housePlus.description}</P></DIV></DIV></DIV></DIV>
